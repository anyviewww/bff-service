...
func (c *menuServiceClient) CreateDish(ctx context.Context, in *CreateDishRequest, opts ...grpc.CallOption) (*DishResponse, error) {
	out := new(DishResponse)
	err := c.cc.Invoke(ctx, "/menu.MenuService/CreateDish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *menuServiceClient) GetMenu(ctx context.Context, in *GetMenuRequest, opts ...grpc.CallOption) (*MenuResponse, error) {
...
func (UnimplementedMenuServiceServer) CreateDish(context.Context, *CreateDishRequest) (*DishResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDish not implemented")
}
func (UnimplementedMenuServiceServer) GetMenu(context.Context, *GetMenuRequest) (*MenuResponse, error) {
...
func _MenuService_CreateDish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/menu.MenuService/CreateDish",
	}
