...
type OrderServiceClient interface {
	...
	GetUserOrders(ctx context.Context, in *GetUserOrdersRequest, opts ...grpc.CallOption) (*UserOrdersResponse, error)
}
...
func (c *orderServiceClient) GetUserOrders(ctx context.Context, in *GetUserOrdersRequest, opts ...grpc.CallOption) (*UserOrdersResponse, error) {
...
type OrderServiceServer interface {
	...
	GetUserOrders(context.Context, *GetUserOrdersRequest) (*UserOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) GetUserOrders(context.Context, *GetUserOrdersRequest) (*UserOrdersResponse, error) {
